        ...
        fetch(stockCheck)
            ...
            .then(data => {
                if(quantity + 1 <= data.stock) {
                    ...
                    updatebooking({id: id, size: size, quantity: quantity});
...
function updatebooking(modifiedProduct) {
    var stockCheck = new Request('/ajax/updatebooking', {
...
function updateTotal(id, size, qnty, operation) {
    ...
    let total = document.querySelector(`#bookingTotal`);
